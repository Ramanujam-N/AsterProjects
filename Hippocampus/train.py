...
datadict_train = Hippocampus_Reader(data['train_imgs'],data['train_gts'],transform=train_transforms)
datadict_val = Hippocampus_Reader(data['val_imgs'],data['val_gts'],transform=val_transforms)
