...
from ImageLoader.ImageLoader import Hippocampus_Reader
from Architecture.UNet import UNet
from Architecture.VGG_FCN import VGG_FCN
...
datadict_test = Hippocampus_Reader(data['test_imgs'],data['test_gts'],transform=test_transforms)
...
model.load_state_dict(torch.load('./models/VGG_FCN_state_dict_best_loss0.pth')['model_state_dict'])
